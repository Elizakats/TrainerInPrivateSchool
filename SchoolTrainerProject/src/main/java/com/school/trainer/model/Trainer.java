 ...
 */
package com.school.trainer.model;
...
public class Trainer implements Serializable {
    ...
    @Size(max=25, message="Name no more than 25 characters")
    @Basic(optional = false)
    @Column(name = "first_name")
    private String firstName;
     @Size(max=25, message="Last name no more than 25 characters")
    @Basic(optional = false)
    ...
    public String toString() {
        return "com.school.trainer.model.Trainer[ trainerId=" + trainerId + " ]";
    }
